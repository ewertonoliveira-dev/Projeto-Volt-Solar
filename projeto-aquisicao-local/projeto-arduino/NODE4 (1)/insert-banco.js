...
const registros_mantidos_tabela_leitura = 20;
...
function registrar_leitura(luminosidade) {
    ...
    banco.conectar().then(() => {
        ...
        INSERT into Dados_sensor (fkSensor, captacao, dataDado, posicao)
        values (2, ${luminosidade}, CONVERT(Datetime, '${agora()}', 120),${posicao});
...
if (gerar_dados_aleatorios) {
	...
	setInterval(function() {
		...
		registrar_leitura(parseInt(Math.random() * (3000 - 800) + 800))
